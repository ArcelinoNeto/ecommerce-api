...
ActiveRecord::Schema.define(version: 2022_04_14_190526) do
  ...
  create_table "system_requirements", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "name"
